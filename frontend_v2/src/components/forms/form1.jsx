                ...
                <div className='min-h-screen sm:flex sm:flex-row mx-0 justify-center'>
                    <div className="flex-col flex self-center p-12 sm:max-w-5xl xl:max-w-2xl z-10">
                        <div className="self-start hidden lg:flex flex-col text-white">
                            ...
                            <h2 className="mb-3 font-bold text-3xl">Hello! We're glad to see you again.</h2>
                            <p className="pr-3 text-lg">
                                RJ Courier is your trusted partner for fast, safe, and reliable deliveries.
                                Login to track your shipments, manage orders, and experience seamless courier services.
                            </p>
                        </div>
                    </div>
