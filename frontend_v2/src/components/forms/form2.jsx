        ...
        await fetch('/api/v1/signup', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert('Password must be at least 5 characters and please check your email address')
                    navigate('/signup')
                }
            })
                ...
                <div className='min-h-screen sm:flex sm:flex-row mx-0 justify-center'>
                    <div className="flex-col flex self-center p-12 sm:max-w-5xl xl:max-w-2xl z-10">
                        <div className="self-start hidden lg:flex flex-col text-white">
                            <h1 className="text-4xl font-extrabold mb-2">RJ Courier</h1>
                            <h2 className="mb-3 font-bold text-3xl">No Account? Create one today.</h2>
                            <p className="pr-3 text-lg">
                                Join RJ Courier to book deliveries, track shipments, and manage your orders 
                                effortlessly. Experience a fast, secure, and reliable courier service designed 
                                to keep your business and personal parcels moving without worry.
                            </p>
                        </div>
                    </div>
                            ...
                            <form onSubmit={handleSubmit} className='space-y-4'>
                                ...
                                <div className='flex flex-row'>
                                    <label className='ml-2 text-sm text-slate-700 tracking-wide'>
                                        ...
                                        <Link to='/'>
                                            <span className='inline ml-1 text-sm text-slate-700 no-underline hover:text-blue-700'>
                                                Sign in
                                            </span>
                                        </Link>
                                    </label>
